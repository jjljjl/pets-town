...
import pet.common.HttpConstants;
import pet.json.JsonDateValueProcessor;

import java.util.Date;

/**
 * Created by developer on 2017/3/7.
 */
    ...
    public String responseResult(Object obj){
        ...
        if(obj != null){
            ...
            if(HttpConstants.SERVICE_RESPONSE_SUCCESS_CODE.equals(jsonObject.getString(HttpConstants.SERVICE_RESPONSE_RESULT_FLAG))){
                ...
                String errMsg = jsonObject.getString(HttpConstants.SERVICE_RESPONSE_RESULT_MSG);
                jsonObject.element(HttpConstants.SERVICE_RESPONSE_RESULT_MSG, errMsg==null?HttpConstants.SERVICE_RESPONSE_NULL:errMsg);
            }
        }
        logger.info("输出结果：{}", jsonObject.toString());
